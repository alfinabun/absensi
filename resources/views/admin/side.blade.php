        ...
        <div> <a href="#" class="nav_logo"> <img src="{{ asset('image/logokarya.png') }}" alt=""
            ...
            <div class="nav_list">
                ...
                <a href="{{ route('kehadiran') }}"
                    class="nav_link {{ request()->routeIs('kehadiran') ? 'active' : '' }}">
                    <img src="{{ asset('image/kalender.svg') }}" alt="" width="47%">
                    <span class="nav_name kehadiran">Kehadiran</span>
                </a>

                <a class="nav_link d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                    href="#submenuMasterData" role="button" aria-expanded="false" aria-controls="submenuMasterData">
                ...
                <div class="collapse ps-4 {{ request()->routeIs('data_pegawai') || request()->routeIs('libur') ? 'show' : '' }}"
                    id="submenuMasterData">
                    <a href="{{ route('data_pegawai') }}"
                        class="nav_link d-flex align-items-center gap-2 {{ request()->routeIs('data_pegawai') ? 'active' : '' }}">
                        <img src="{{ asset('image/user.svg') }}" alt="" width="11%">
                        <span class="nav_name kar ms-2">Data Karyawan</span>
                    </a>
                    <a href="{{ route('libur') }}"
                        class="nav_link d-flex align-items-center gap-2 {{ request()->routeIs('libur') ? 'active' : '' }}">
