    ...
    <form action="{{ route('setting.absen') }}" method="POST" class="p-4 rounded"
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="lokasi" class="form-control" style="border-color: #DFCDE1;"
                    value="{{ $lokasi->lokasi }}">
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Batas Jarak (Meter)</label>
                <input type="number" name="batas_jarak" class="form-control" style="border-color: #DFCDE1;"
                    value="{{ $lokasi->batas_jarak }}">
            </div>
        </div>
            ...
            <div class="card"
                ...
                <div class="card-body d-flex justify-content-center align-items-center">
                    <iframe class="p-3" style="left:0;top:0;height:100%;width:100%;position:absolute;"
                        src="https://maps.google.com/maps?q={{ $lokasi->lokasi }}&output=embed" width="800"
