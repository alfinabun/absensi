...
<div class="row d-flex align-items-stretch">
    ...
    <div class="col-sm-8 mt-3 mb-3">
        <div class="card" style="padding: 20px; height:100%;">
            ...
            <form action="{{ route('ubahprofil') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <a href="{{ route('user.dashboard') }}" class="btn btn-secondary ms-2" style="padding: 10px;">Batal</a>
            </form>
        </div>
    </div>
</div>
